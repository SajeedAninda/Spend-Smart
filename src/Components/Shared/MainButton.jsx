...
const MainButton = ({ text, icon: Icon, onClick, className = '' }) => {
  return (
    <div className='relative group'>
      <button
        className={`relative inline-block p-px font-semibold leading-6 text-white bg-[#02101c] shadow-lg cursor-pointer rounded-xl shadow-zinc-900 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95 ${className}`}
        onClick={onClick}
      >
